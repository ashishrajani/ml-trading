...
def find_optimum_allocs(prices):
    ...
    result = spo.minimize(error_optimal_allocs, function_Cguess, args=(prices,), method='SLSQP', bounds=bnds,
...
def optimize_portfolio(sd, ed, syms, gen_plot=True):
    ...
    normed_SPY = prices_SPY / prices_SPY.values[0]
    if gen_plot:
