import pandas as pd
import utils
from models.LinRegLearner import LinRegLearner
...
if __name__ == "__main__":
    ...
    lin_reg = LinRegLearner()
    lin_reg.train(df_x, prices_symbols)

    y_pred = pd.DataFrame(lin_reg.query(df_x), index=df_x.index, columns=['XOM', 'PG'])
